  ...
  const SidebarContent = () => (
    <aside className="flex flex-col h-full bg-primary">
      <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
        <img src={logoDataUrl} alt="전일련" className="w-10 h-10 rounded-full object-cover ring-2 ring-white/20 shrink-0" />
        <div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-card border-b border-border px-6 py-3.5 flex items-center gap-4 shrink-0">
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <span className="text-muted-foreground text-xs hidden sm:block">전일련 회원관리 시스템</span>
        ...
        <main className="flex-1 overflow-auto p-6">
          {page === "dashboard" && <Dashboard members={members} />}
          {page === "members" && (
            <MemberTable
              members={members}
          ...
          {page === "mutualaid" && <MutualAidManager members={members} />}
