  ...
  return (
    <div className="min-h-screen bg-primary flex">
      ...
      <div className="hidden lg:flex flex-col items-center justify-center w-1/2 px-16 gap-8">
        <img src={logoDataUrl} alt="전일련 로고" className="w-48 h-48 rounded-full object-cover ring-4 ring-white/20 shadow-2xl" />
      ...
      <div className="flex-1 flex items-center justify-center bg-background px-8">
        <div className="w-full max-w-sm">
          ...
          <div className="flex flex-col items-center mb-8 lg:hidden">
            <img src={logoDataUrl} alt="전일련 로고" className="w-20 h-20 rounded-full object-cover mb-3" />
          ...
          <form onSubmit={handleSubmit} className={`space-y-4 ${shake ? "animate-[shake_0.4s_ease]" : ""}`}>
            <div>
              ...
              <input
                ...
                placeholder="아이디 입력"
                className="w-full border border-border rounded-lg px-4 py-3 text-sm bg-muted text-foreground outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
              />
            </div>
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="비밀번호 입력"
                  className="w-full border border-border rounded-lg px-4 py-3 pr-11 text-sm bg-muted text-foreground outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                />
            ...
            <button type="submit" className="w-full bg-primary text-white py-3 rounded-lg font-semibold text-sm flex items-center justify-center gap-2 hover:bg-primary/90 transition-colors">
              <LogIn size={16} /> 로그인
            </button>
          </form>
