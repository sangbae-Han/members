...
import { parseQuery, filterByParsedQuery, SUGGESTIONS, type ParsedQuery } from "@/utils/smartSearch";
      ...
      <div className="bg-primary px-5 pt-12 pb-4">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2 flex-1">
            <img src={logoDataUrl} alt="전일련 로고" className="rounded-full object-cover ring-2 ring-white/30 shrink-0" style={{ width: "48px", height: "48px" }} />
            <div>
          ...
          <div className="flex items-center justify-between bg-white/15 rounded-xl px-4 py-2.5">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
                someSelected ? "bg-red-500 text-white" : "bg-white/10 text-blue-300"
              }`}
            >
              <Trash2 size={14} />
