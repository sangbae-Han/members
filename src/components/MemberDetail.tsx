        ...
        {tab === "info" && (
          <div className="space-y-3">
            ...
            <div className="bg-card rounded-2xl px-4 shadow-sm">
              ...
              {member.roadAddress && (
                <InfoRow icon={<MapPin size={14} />} label="도로명주소">
                  <p className="text-foreground text-sm">{member.roadAddress}</p>
                </InfoRow>
              )}
              {member.mailingAddress && (
                <InfoRow icon={<MapPin size={14} />} label="우편주소">
                  <p className="text-foreground text-sm">{member.mailingAddress}</p>
                </InfoRow>
              )}
            </div>
