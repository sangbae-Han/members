...
import type { Member, VehicleType, MemberGrade, MemberStatus, GarageRegion, SpecialEquipment } from "../components/types";
...
const inputClass = "w-full bg-input-background border border-border rounded-lg px-3 py-2 text-sm text-foreground outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all";
              ...
              <Field label="도로명 주소">
                <div className="flex gap-2">
                  <input
                    ...
                    readOnly
                    placeholder="아래 [주소 검색] 버튼을 눌러 선택하세요"
                  />
                  <button
                    type="button"
