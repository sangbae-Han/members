...
import type { Member, AidCategory } from "../components/types";
      ...
      <div className="bg-card rounded-xl border border-border p-4 flex flex-wrap items-center gap-3">
        ...
        <div className="relative min-w-52 flex-1">
          ...
          <input
            ...
            className="w-full bg-input-background border border-border rounded-lg pl-9 pr-8 py-2 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
          />
          {searchQuery && (
              ...
              {paginated.length === 0 ? (
                ...
                <tr key={r.recordId} className="hover:bg-muted/30 transition-colors">
                  ...
                  <td className="px-5 py-3.5">
                    <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${AID_CATEGORY_COLORS[r.category]}`}>
                      {r.category}
                    </span>
                  </td>
                  ...
                  <td className="px-5 py-3.5 text-right font-semibold text-blue-600 whitespace-nowrap">
