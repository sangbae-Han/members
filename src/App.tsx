...
import type { Member, DisciplineRecord, MutualAidRecord, SpecialEquipment } from "./types";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        const [apiMembers, apiAdmins] = await Promise.all([apiGetMembers(), apiGetAdmins()]);
